...
1. DATA PRIVACY (GDPR/CCPA)
   ...
   ▸ Method: Regex-based masking (Email, Phone, SSN)
     before API egress.
   ▸ External Data Sharing: Only anonymized contexts
     sent to AI providers.

2. AI TOKEN GOVERNANCE
   ▸ Providers: Mistral AI (primary), Google Gemini (fallback)
...
3. DATA PROVENANCE
   ...
   ▸ Enrichment: Public Web Data via AI
...
════════════════════════════════════════
Verified by Nebula Intelligence Agent.
    ''';
  }
}
